    ...
    return (
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="title" className="text-white">Tiêu đề hẹn chơi *</Label>
                  <Input
                    id="title"
                    {...register("title")}
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="gameType" className="text-white">Thể loại *</Label>
                  <Select onValueChange={(value) => setValue("gameType", value as any)}>
                    ...
                    <SelectContent className="bg-gray-700 border-gray-600">
                      <SelectItem value="CASUAL" className="text-white">Casual - Chơi vui</SelectItem>
                      <SelectItem value="RANKED" className="text-white">Ranked - Cày rank</SelectItem>
                      <SelectItem value="COMPETITIVE" className="text-white">Competitive - Thi đấu</SelectItem>
                    </SelectContent>
                  </Select>
                  {errors.gameType && (
                ...
                <div>
                  <Label htmlFor="rankLevel" className="text-white">Mức rank</Label>
                  <Input
                    id="rankLevel"
                    {...register("rankLevel")}
              ...
              {/* Time and Tier */}
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-white">Thời gian và Tier</h3>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="startTime" className="text-white">Thời gian bắt đầu *</Label>
                    <Input
                      id="startTime"
                      type="datetime-local"
                      {...register("startTime")}
                  ...
                  <div>
                    <Label htmlFor="endTime" className="text-white">Thời gian kết thúc *</Label>
                    <Input
                      id="endTime"
                      type="datetime-local"
                      {...register("endTime")}
                ...
                <div>
                  ...
                  {isLoadingTiers ? (
                    <div className="flex items-center gap-2 p-3 bg-gray-700 border border-gray-600 rounded-md">
                      ...
                      <span className="text-gray-400">Đang tải danh sách tier...</span>
                    </div>
                  ) : (
                        ...
                        {availableTiers.map((tier) => (
                          <SelectItem key={tier.tierName} value={tier.tierName} className="text-white">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-gray-400">({tier.minMembers} người)</span>
                            </div>
                          </SelectItem>
                        ))}
                      </SelectContent>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-blue-200">
                          ...
                          {tierPreview.maxMembers && ` (tối đa ${tierPreview.maxMembers})`}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
              ...
              {tierPreview && (
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-white">Ưu đãi và phần thưởng</h3>
                  <div className="bg-green-900/30 border border-green-700 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-3">
                      <Gift className="h-5 w-5 text-purple-400" />
                      <span className="font-semibold text-green-300 text-lg">Các ưu đãi hấp dẫn</span>
                    </div>

                    <div className="mb-3">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="text-sm font-medium text-green-300">🎯 Nhiệm vụ và phần thưởng:</span>
                      </div>
                    ...
                    <div className="border-t border-green-600 pt-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-green-300">
                          💰 Số tiền khóa: <strong>{tierPreview.lockedAmount.toLocaleString()} VNĐ/người</strong>
                        </span>
                      </div>
                    </div>
                  </div>
