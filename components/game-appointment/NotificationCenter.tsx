...
export function NotificationCenter({ userId }: NotificationCenterProps) {
      ...
      const mockNotifications: Notification[] = [
        {
          ...
          message: 'Hẹn chơi "Valorant Ranked" cho game Valorant đã được tạo thành công.',
          isRead: false,
        ...
        },
        {
          ...
          message: 'Tier của hẹn chơi "Valorant Ranked" đã thay đổi từ Silver sang Gold. Bạn được hưởng promotion: Đồng Đội Đồng Lòng',
          isRead: false,
          ...
          data: {
            ...
            promotion: {
              ...
              description: 'Mỗi thành viên mua 1 suất ăn bất kỳ, được tặng 1 combo (Nước + Snack)',
              minNetProfit: 42500
            }
          }
        },
        {
          ...
          message: 'Có thành viên mới tham gia hẹn chơi "League of Legends". Hiện tại có 4/5 thành viên.',
          isRead: true,
  ...
  const getNotificationBadge = (type: string) => {
    const typeConfig = {
      ...
      'APPOINTMENT_COMPLETED': { label: 'Hoàn thành', variant: 'secondary' as const },
      'APPOINTMENT_CANCELLED': { label: 'Hủy', variant: 'destructive' as const }
    };

    const config = typeConfig[type as keyof typeof typeConfig] || typeConfig.APPOINTMENT_CREATED;
