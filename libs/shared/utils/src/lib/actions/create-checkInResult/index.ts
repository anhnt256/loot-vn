...
import { db, MainPrisma } from "@gateway-workspace/database";
...
import { calculateActiveUsersInfo } from "../../user-calculator";
import { getCurrentTimeVNISO, getCurrentTimeVNDB, getStartOfDayVNISO } from "../../timezone-utils";
...
const handler = async (data: InputType): Promise<ReturnType> => {
  ...
  try {
    ...
    await db.$transaction(async (tx: MainPrisma.TransactionClient) => {
