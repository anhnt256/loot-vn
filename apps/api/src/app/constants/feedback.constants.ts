...
export const FEEDBACK_TYPE_LABELS = {
  ...
  [FEEDBACK_TYPE_ENUM.RESTOCK_REQUEST]: 'Yêu cầu nhập hàng',
} as const;
...
export type FeedbackType =
  (typeof FEEDBACK_TYPE_ENUM)[keyof typeof FEEDBACK_TYPE_ENUM];
export type FeedbackCategory =
  (typeof FEEDBACK_CATEGORY_ENUM)[keyof typeof FEEDBACK_CATEGORY_ENUM];
export type FeedbackPriority =
  (typeof FEEDBACK_PRIORITY_ENUM)[keyof typeof FEEDBACK_PRIORITY_ENUM];
export type FeedbackStatus =
  (typeof FEEDBACK_STATUS_ENUM)[keyof typeof FEEDBACK_STATUS_ENUM];
