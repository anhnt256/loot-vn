...
import { useLogin } from "@gateway-workspace/shared/utils";
...
import { Card } from "@gateway-workspace/shared/ui";
import { getMacAddresses } from "@gateway-workspace/shared/utils";
  ...
  const handleLogin = useCallback(
    async (isAutoLogin: boolean = false) => {
      ...
      if (isStaffMacLogin) {
        ...
        toast.error(
          `Tên đăng nhập không hợp lệ. Vui lòng sử dụng trang đăng nhập nhân viên.`,
        );
        return;
      } else {
