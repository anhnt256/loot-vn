...
const AdminLogin = () => {
  ...
  const onLogin = async () => {
    ...
    if (userName !== "gateway_admin" && !ADMIN_MAC_MAPPING[macAddress]) {
    ...
    setPageLoading(true);
    try {
      // Set branch based on MAC if provided, otherwise use cookie
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="Enter gateway_admin"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="Enter MAC address if available"
                  />
                </div>
              </div>
