...
export async function GET(request: NextRequest) {
  ...
  if (USE_MOCK_DATA) {
    ...
    const salaryForMonth = selectedMonth === 12 ? {
      id: 1,
      month: 12,
      year: 2024,
      totalHours: 176.5,
    ...
    const bonusForMonth = selectedMonth === 12 ? [
      {
        id: 1,
        amount: 500000,
    ...
    const penaltiesForMonth = selectedMonth === 12 ? [
      {
        id: 1,
        amount: 150000,
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        summary: {
          ...
          netSalary: (salaryForMonth.salaryFromHours || 0) + 
