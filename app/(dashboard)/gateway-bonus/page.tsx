        ...
        <div className="text-center mb-12">
          ...
          <div className="bg-red-500/20 border border-red-500/30 rounded-lg p-3">
            <p className="text-red-300 text-sm font-semibold">
              ⚠️ HẠN CUỐI: 15/07/2025 - Không claim sẽ mất phần thưởng vĩnh viễn!
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-white font-semibold flex items-center">
                  ...
                  <Image src="/star.png" width={20} height={20} alt="stars" className="ml-1" />
                </span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-white font-semibold">
                  {userData?.createdAt ? dayjs(userData.createdAt).format("DD/MM/YYYY") : "N/A"}
                </span>
              </div>
                 ...
                 <span className="text-red-400 font-semibold">
                   {status.deadline ? dayjs(status.deadline).format("DD/MM/YYYY") : "15/07/2025"}
                 </span>
               </div>
            </div>
          </div>
              ...
              <div className="text-center">
                   ...
                   <div className="bg-yellow-500/20 border border-yellow-500/30 rounded-lg p-3">
                     <p className="text-yellow-300 text-sm font-semibold">
                       ⏰ Chỉ còn {status.deadline ? dayjs(status.deadline).diff(dayjs(), 'day') : 0} ngày để nhận thưởng!
                     </p>
                   </div>
                 </div>
                ...
                {status.reason === "expired" && (
                  <div className="bg-red-500/20 border border-red-500/30 rounded-lg p-4">
                    <p className="text-red-200 text-sm">
                      Chương trình đã kết thúc vào ngày {status.deadline ? dayjs(status.deadline).format("DD/MM/YYYY") : "15/07/2025"}
                    </p>
                  </div>
                )}
                ...
                {status.reason === "new_account" && (
                  <div className="bg-yellow-500/20 border border-yellow-500/30 rounded-lg p-4">
                    <p className="text-yellow-200 text-sm">
                      Chỉ áp dụng cho tài khoản tạo trước ngày {status.accountDeadline ? dayjs(status.accountDeadline).format("DD/MM/YYYY") : "05/07/2025"}
                    </p>
                  </div>
                )}
                ...
                {status.reason === "already_claimed" && (
                  <div className="bg-blue-500/20 border border-blue-500/30 rounded-lg p-4">
                    <p className="text-blue-200 text-sm">
                      Bạn đã nhận Gateway Bonus rồi. Hãy sử dụng 3 lượt quay miễn phí trong trò chơi!
                    </p>
                  </div>
                )}
              </div>
         ...
         <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
           ...
           <div className="grid md:grid-cols-2 gap-6 text-sm">
             <div>
               <h4 className="text-blue-300 font-semibold mb-2">Điều kiện tham gia:</h4>
             ...
             <div>
               <h4 className="text-green-300 font-semibold mb-2">Phần thưởng:</h4>
               <ul className="text-gray-300 space-y-1">
           ...
           <div className="mt-6 p-4 bg-red-500/20 border border-red-500/30 rounded-lg">
             ...
             <ul className="text-red-200 text-sm space-y-1">
               <li>• Chương trình Gateway Bonus sẽ kết thúc vào ngày <strong>15/07/2025</strong></li>
               <li>• Sau ngày này, tính năng sẽ bị ẩn và không thể nhận thưởng</li>
