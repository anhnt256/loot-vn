...
const RewardHistory: React.FC<RewardHistoryProps> = ({ userId }) => {
  ...
  // Tính toán màu sắc icon dựa trên giá trị phần thưởng
    ...
    return (
      <div className="flex flex-col h-full">
        <div className="p-4 border-b bg-gradient-to-r from-gray-50 to-gray-100">
          <h3 className="text-lg font-semibold text-gray-800">Lịch sử đổi thưởng</h3>
        </div>
    ...
    <div className="flex flex-col h-full">
      <div className="p-4 border-b bg-gradient-to-r from-gray-50 to-gray-100">
        ...
        <div className="flex items-center justify-between text-xs text-gray-500">
          ...
          <span>
            Cập nhật sau: {timeUntilUpdate}s
          </span>
        </div>
      </div>
        ...
        {historyData.rewards.length > 0 ? (
                ...
                <div className="flex justify-between items-start mb-3">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center space-x-2 mb-1">
                      <div className={`w-8 h-8 ${getRewardIconStyle(item.reward?.value || 0)} rounded-lg flex items-center justify-center`}>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600 font-medium">
                          {item.reward?.value?.toLocaleString()} sao
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              ...
              <p className="text-gray-500 font-medium text-lg mb-2">Chưa có lịch sử đổi thưởng</p>
              <p className="text-gray-400 text-sm">Hãy đổi thưởng đầu tiên để xem lịch sử</p>
            </div>
          </div>
        )}
      </div>
